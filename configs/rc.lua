...
beautiful.menu_bg_focus="#f5e74c"
-- beautiful.menu_fg_normal=""
beautiful.menu_fg_focus="#000000"
local menu_awesome = { "Awesome", myawesomemenu, beautiful.awesome_icon }
local menu_terminal = { "Open Terminal", "gnome-terminal" },
...
globalkeys = gears.table.join(
    -- My Bindings
    awful.key({ modkey,		  }, ";", function () awful.spawn.with_shell("xscreensaver-command -lock") end),
...
awful.spawn.with_shell("picom --config /home/mcrn/.config/picom/p.conf")
awful.spawn.with_shell("/home/mcrn/.config/polybar/launch.sh")
